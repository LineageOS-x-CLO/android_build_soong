...
func IsDepInSameApex(ctx BaseModuleContext, module, dep blueprint.ModuleOrProxy) bool {
...
func ShouldSupportSdkVersion(ctx BaseModuleContext, module blueprint.ModuleOrProxy, sdkVersion ApiLevel) error {
